...
export default function TownLoginPage() {
  ...
  const description =
    town?.description ||
    "Tu puerta de entrada a descubrir increíbles lugares, gastronomía local y el encanto turístico de Costa Rica.";
  ...
  return (
    <div className="min-vh-100 bg-white">
      ...
      <section
        ...
        style={{
          minHeight: "650px",
          backgroundImage: `linear-gradient(rgba(0, 70, 100, 0.45), rgba(0, 0, 0, 0.35)), url(${heroImage})`,
          backgroundSize: "cover",
          backgroundPosition: "center"
        }}
      >
        <div className="container px-4">
          <span className="badge bg-info rounded-pill px-4 py-2 mb-3">
            Destino turístico local
          </span>

          <h1 className="display-3 fw-bold mb-3">
            Bienvenido a <span className="text-info">{townName}</span>
          </h1>
        ...
        <div className="container">
          <div className="text-center mb-5">
            ...
            <p className="text-muted">
              Encuentra guías, lugares recomendados y acceso rápido desde QR.
            </p>
          </div>
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="card border-0 shadow-sm rounded-4 h-100 p-4">
                ...
                <p className="text-muted small mb-0">
                  Playas, restaurantes, miradores, hoteles y actividades en un solo catálogo.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="card border-0 shadow-sm rounded-4 h-100 p-4">
                ...
                <p className="text-muted small mb-0">
                  Filtra fácilmente por tipo de destino y encuentra lo que quieres visitar.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="card border-0 shadow-sm rounded-4 h-100 p-4">
                ...
                <p className="text-muted small mb-0">
                  Ideal para hoteles, restaurantes y puntos de información turística.
                </p>
              </div>
            </div>
          </div>
      ...
      <section
        className="py-5"
        style={{ background: "linear-gradient(90deg, #e0f7ff, #f0fff4)" }}
      >
        <div className="container">
          <div className="row align-items-center g-5">
            ...
            <div className="col-lg-6">
              ...
              <h2 className="display-6 fw-bold mb-3">
                Más que una playa, una experiencia completa
              </h2>

              <p className="text-muted mb-4">
                Explora playas, descubre gastronomía local, encuentra actividades y accede a información útil desde tu celular.
              </p>
              ...
              <Link
                to={`/places/${slug}`}
                className="btn btn-info text-white rounded-pill px-5 py-3 fw-bold"
              >
                Comenzar a explorar
              </Link>
            </div>
      ...
      <section className="py-5 bg-light">
        <div className="container">
          <div className="card border-0 shadow rounded-5 text-center p-5">
            ...
            <p className="text-muted">
              Únete y entra a una guía interactiva hecha para turistas.
            </p>
